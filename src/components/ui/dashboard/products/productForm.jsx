  ...
  useEffect(() => {
    if (initialData) {
      setFormData({
        translations: {
          ar: {
            name: initialData.translations?.ar?.name || "",
            description: initialData.translations?.ar?.description || "",
          },
          en: {
    ...
    <Card className="w-full max-w-4xl mx-auto">
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {/* Notes Section */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold">النوتات العطرية</h3>

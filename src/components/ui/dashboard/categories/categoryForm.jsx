...
export default function CategoryForm({ categoryId = null }) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background">
      <div className="w-full sm:max-w-[90%] mx-auto max-w-[95%]">
        <div className="rounded-xl shadow-xl p-8 border border-border bg-card">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent transition-all duration-200 bg-background text-foreground ${
                    errors.ar_name ? "border-destructive" : "border-border"
                  }`}
                  placeholder={t("categories.categoryName")}
                  dir="rtl"
                />
            ...
            {activeTab === "en" && (
              <div>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent transition-all duration-200 bg-background text-foreground ${
                    errors.en_name ? "border-destructive" : "border-border"
                  }`}
                  placeholder={t("categories.categoryName")}
                />
                {errors.en_name && (
            ...
            <div className="flex gap-4 pt-8">
              <button
                type="submit"
                disabled={isLoading}
                className="flex-1 px-6 py-3 bg-primary text-primary-foreground font-medium rounded-lg transition-all duration-200 hover:bg-primary/90 hover:shadow-lg hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
              >
                {isLoading ? (
                  <div className="flex items-center justify-center gap-2">
              ...
              <button
                type="button"
                onClick={() => router.push("/admin/categories")}
                className="px-6 py-3 bg-secondary text-secondary-foreground font-medium rounded-lg hover:bg-secondary/80 transition-all duration-200 hover:scale-105"
              >
                {t("common.cancel")}
              </button>
            </div>

...
//   if (!mounted) {
//     return (
//       <header className="h-16 flex items-center justify-between px-6 bg-white/95 dark:bg-[#1c283b]/95 backdrop-blur-md border-b border-gray-200/50 dark:border-gray-700/50 shadow-sm relative z-50 transition-all duration-300">
...
//         <div className="hidden md:flex items-center gap-3">
//           <div className="w-10 h-10 bg-gradient-to-br from-[#1c283b] to-[#2d3748] rounded-xl flex items-center justify-center shadow-sm hover:shadow-sm transition-all duration-200 hover:scale-105">
...
//           >
//             <div className="w-9 h-9 bg-gradient-to-br from-[#1c283b] to-[#2d3748] rounded-xl flex items-center justify-center shadow-sm group-hover:shadow-sm transition-all duration-200">
//               {user?.avatar ? (
//                 <img
//                   src={user.avatar}
...
//               <div className="absolute top-full right-0 mt-3 w-56 bg-white/95 dark:bg-[#1c283b]/95 backdrop-blur-md rounded-2xl shadow-sm border border-gray-200/50 dark:border-gray-700/50 z-50 overflow-hidden animate-in slide-in-from-top-2 duration-200">

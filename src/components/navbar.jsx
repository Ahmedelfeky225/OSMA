...
//                   className="fixed top-0 right-0 w-full h-screen bg-[var(--bg-navbar)] shadow-2xl z-50 lg:hidden flex flex-col border-l border-border overflow-hidden mobile-menu-container"
//                 >
//                   {/* Mobile Menu Header */}
            ...
            {isMenuOpen && (
              <>
                ...
                <motion.div
                  ...
                  exit={{ x: "100%" }}
                  transition={{ type: "spring", damping: 25, stiffness: 200 }}
                  className="fixed top-0 right-0 w-full h-screen bg-[var(--bg-navbar)] shadow-2xl z-50 lg:hidden flex flex-col border-l border-border overflow-hidden"

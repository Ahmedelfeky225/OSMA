...
//   return (
//     <div className="min-h-screen !pt-[90px] bg-gradient-to-br from-background via-background to-primary/5">
//       {/* Hero Section */}
...
export async function generateMetadata({ params }) {
  ...
  const baseUrl =
    process.env.NEXT_PUBLIC_FRONTEND_URL || "https://osma-perfume.vercel.app";

  const title =
    locale === "ar"
      ? "من نحن | OSMA للعطور الفاخرة"
      : "About Us | OSMA Luxury Perfumes";

  const description =
    locale === "ar"
      ? "تعرف على رؤية OSMA ورسالتها وحرفية صناعة العطور الفاخرة."
      : "Discover OSMA's vision, mission, and premium perfume craftsmanship.";

  const keywords =
    locale === "ar"
      ? "OSMA, عطور فاخرة, متجر عطور, عطور نسائية, عطور رجالية, عطور شرقية, عطور فرنسية"
      : "OSMA, luxury perfumes, perfume store, women's perfumes, men's perfumes, oriental perfumes, French perfumes";
          ...
          __html: JSON.stringify([
            {
              ...
              "@type": "AboutPage",
              name: locale === "ar" ? "من نحن - OSMA" : "About OSMA",
              description:
                locale === "ar"
                  ? "تعرف على رؤية OSMA ورسالتها وحرفية صناعة العطور الفاخرة."
                  : "Discover OSMA's vision, mission, and premium perfume craftsmanship.",
              ...
              mainEntity: {
                ...
                sameAs: ["https://www.instagram.com/osma_sur/"],
              },
            },
            {
              "@context": "https://schema.org",
